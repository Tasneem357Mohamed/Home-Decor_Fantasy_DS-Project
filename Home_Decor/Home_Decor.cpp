...
void UserManager::signUpUser(std::string &username, std::string &password, std::string &email)
{
...
void UserManager::signInUser(std::string &username, std::string &password)
{
